  ...
  <div className="animate-in fade-in zoom-in-95 duration-500">
    <div className="bg-white rounded-[3rem] p-10 shadow-xl border border-slate-200 relative overflow-hidden text-slate-900 flex flex-col min-h-[600px]">
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex items-center gap-3 mb-8 text-indigo-600 font-normal uppercase text-[12px] tracking-[0.4em]">
        ...
        <button
          ...
          className="w-full py-6 bg-slate-900 text-white rounded-2xl font-normal text-[12px] uppercase tracking-[0.2em] shadow-xl hover:scale-[1.02] active:scale-98 transition-all flex items-center justify-center gap-4 disabled:opacity-50 mb-10"
        >
          {isDiagnosing ? (
        ...
        <div className="flex-1 bg-slate-50 rounded-[2rem] p-10 border border-slate-200 overflow-y-auto no-scrollbar">
          {diagnosisResult ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center opacity-40">
              ...
              <p className="text-[12px] font-normal uppercase tracking-widest text-slate-500">
