  ...
  <div className="animate-in fade-in zoom-in-95 duration-500">
    <div className="bg-white rounded-[3rem] p-10 shadow-xl border border-slate-200 relative overflow-hidden text-slate-900 flex flex-col min-h-[600px]">
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex items-center gap-3 mb-8 text-indigo-600 font-normal uppercase text-xs tracking-[0.4em]">
          <BrainCircuit className="w-6 h-6" /> AI CFO Advisor
        </div>
        <h2 className="text-4xl font-semibold text-slate-900 uppercase tracking-tighter leading-tight mb-8">
        ...
        <button
          ...
          className="w-full py-6 bg-slate-900 text-white rounded-2xl font-normal text-xs uppercase tracking-[0.2em] shadow-xl hover:scale-[1.02] active:scale-98 transition-all flex items-center justify-center gap-4 disabled:opacity-50 mb-10"
        >
          {isDiagnosing ? (
