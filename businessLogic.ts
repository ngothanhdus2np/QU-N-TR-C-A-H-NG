...
import { Employee, SalaryPolicy, AttendanceRecord, OvertimeRecord, SalesRecord, ShortageRecord, AdvanceRecord, PayrollRecord, Holiday, TetCampaign, ViolationType, ViolationOccurrence, ProductGroupRevenue, ProductGroup, ExpenseRecord, RevenueRecord, DiagnosisRange, ExpenseCategory, POSProduct, POSProductAttribute } from './types';
import * as XLSX from 'xlsx';

/**
 * Tạo Cartesian product của mảng các giá trị thuộc tính
